...
UCLASS()
class VRPROJECT_API UVRGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	ABaseCharacter* GetAvatarCharacter() const { return AvatarCharacter.Get(); }

protected:

	// Pointer to Avatar Character
	TObjectPtr<ABaseCharacter> AvatarCharacter = nullptr;
